import { UploadCloud, Lock, Database } from "lucide-react";
...
export default function UaliiChat() {
  return (
    <div className="overflow-hidden bg-gray-900 w-full">
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-8 py-16 md:py-32 lg:py-44">
